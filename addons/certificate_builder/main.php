...
class STM_LMS_Certificate_Builder {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'pdfjs', STM_LMS_URL . 'assets/vendors/pdf.min.js', array(), MS_LMS_VERSION, true );
		wp_enqueue_script( 'pdfjs_worker', STM_LMS_URL . 'assets/vendors/pdf.worker.min.js', array(), MS_LMS_VERSION, true );
