...
<?php endif; ?>
	...
	<div class="stm_lms_my_course_bundles__list <?php echo esc_attr( implode( ' ', $list_classes ) ); ?>">
		<?php foreach ( $bundles_list as $bundle ) : ?>
			<?php STM_LMS_Templates::show_lms_template( 'bundle/deprecated/main', compact( 'bundle', 'courses' ) ); ?>
		<?php endforeach; ?>
	</div>

	<?php STM_LMS_Templates::show_lms_template( 'bundle/deprecated/pagination', compact( 'pages' ) ); ?>
