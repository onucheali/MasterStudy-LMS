...
wp_enqueue_style( 'masterstudy-account-student-assignments-table' );
wp_enqueue_style( 'masterstudy-loader' );
wp_enqueue_script( 'masterstudy-account-student-assignments-list' );
wp_localize_script(
	'masterstudy-account-student-assignments-list',
	'stm_lms_assignment',
	array(
...
<div class="masterstudy-account">
	...
	<div class="masterstudy-account-container">
		...
		<div class="masterstudy-account-student-assignment">
				...
				<div class="masterstudy-table__wrapper">
					...
					<div class="masterstudy-tbody">
						<div class="masterstudy-table__item masterstudy-table__item--hidden masterstudy-table__item--clone">
							<div class="masterstudy-tcell masterstudy-tcell_is-grow-md" data-th="<?php echo esc_html__( 'Student name', 'masterstudy-lms-learning-management-system-pro' ); ?>:" data-th-inlined="false">
							...
							<div class="masterstudy-tcell masterstudy-tcell_is-start masterstudy-tcell_is-sm-space-between masterstudy-tcell_is-sm-border-bottom" data-th="<?php echo esc_html( $theads['try_num']['title'] ?? '' ); ?>:" data-th-inlined="true">
							...
							<div class="masterstudy-tcell masterstudy-tcell_is-start masterstudy-tcell_is-sm-space-between" data-th="<?php echo esc_html( $theads['status']['title'] ?? '' ); ?>:" data-th-inlined="true">
								<div class="masterstudy-tcell__icon-title">
									<span class="masterstudy-tcell__icon"></span>
							...
							<?php if ( is_ms_lms_addon_enabled( 'grades' ) ) : ?>
								<div class="masterstudy-tcell masterstudy-tcell_is-start masterstudy-tcell_is-sm-space-between masterstudy-tcell_is-sm-border-bottom" data-th="<?php echo esc_html( $theads['grade']['title'] ?? '' ); ?>:" data-th-inlined="true">
									...
									<div class="masterstudy-tcell__data masterstudy-tcell__grade" data-key="grade" data-value=""></div>
								</div>
							<?php endif; ?>
