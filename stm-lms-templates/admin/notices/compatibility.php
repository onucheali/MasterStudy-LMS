...
<hr>
<h4>
	<i class="masterstudy-update-notice__header-icon stmlms-exclamation-circle"></i> <?php esc_html_e( 'Important!', 'masterstudy-lms-learning-management-system-pro' ); ?>
</h4>
...
<hr>
<h4>
	<i class="masterstudy-update-notice__header-icon stmlms-exclamation-circle"></i> <?php esc_html_e( 'Check Compatibility:', 'masterstudy-lms-learning-management-system-pro' ); ?>
</h4>
<p class="masterstudy-update-notice__text">
